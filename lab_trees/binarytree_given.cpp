...
// This is a template so we can declare it outside of the .h file - we don't need to actually see
// the BinaryTree<T>::Node class
template <typename Node>
class BinaryTreeNodeDescriptor : public GenericNodeDescriptor<BinaryTreeNodeDescriptor<Node> >
{
	public:
	...
	BinaryTreeNodeDescriptor left() const { return BinaryTreeNodeDescriptor(node->left); }
	BinaryTreeNodeDescriptor right() const { return BinaryTreeNodeDescriptor(node->right); }
