...
namespace filler {
    ...
    namespace dfs {
        ...
        /**
		 * Performs a flood fill on the given image using a grid, employing
		 ...
		 * @param gridSpacing The width and height of the cells of the
		 *	grid.
		 * @param tolerance How far away colors are allowed to be to still
		 *	be included in the fill: this is given as squared euclidean
		 *	distance in RGB space (i.e. \f$(c1.red - c2.red)^2 + (c1.green
		 ...
		 *  image.
		 */
        animation fillGradient( PNG & img, int x, int y, 
