...
class Vector2
{
	...
	public:
		...
		/**
		 * @brief Multiples the current Vector2 by a scalar and returns a new Vector2 with
		 * its value
		 *
		...
		/**
		 * @brief Divides the current Vector2 by a scalar and returns a new Vector2 with
		 * its value
		 *
		...
		/**
		 * @brief Computes and returns the dot product of the current Vector2 and other
		 * Vector2
		 *
		 * @param other
		 *
		...
		/**
		 * @brief Computes and returns the cross product of the current Vector2 and the
		 * other Vector2
		 *
		 * @param other
		 *
		 ...
		 *
		 * @return the Vector2 representing the projection of the current Vector2 onto b
		 */
